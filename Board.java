...
public class Board {
    ...
    public Board() {
        p1 = new Player(1, 'B', "BIR");
        p2 = new Player(2, 'K', "KUN");
        p3 = new Player(3, 'H', "HIJ");
        p4 = new Player(4, 'M', "MER");
        d = new Dice(p3);
    ...
    private void gamestarted() {
        d.current_player = p1;
        write_to_board_array(62, 86, "BIR");
    ...
    private void updateBoard() {
        ...
        switch (d.current_player.id) {
            case 1:
                ...
                break;
            case 2:
                write_to_board_array(62, 86, "KUN");
                break;
            case 3:
                write_to_board_array(62, 86, "HIJ");
                break;
            case 4:
                write_to_board_array(62, 86, "MER");
                break;
            default:
                System.out.println("");
                break;
